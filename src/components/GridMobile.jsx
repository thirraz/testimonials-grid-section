      ...
      <div className="grid grid-flow-row grid-row-5 grid-col-1 gap-4 text-white w-90pc mt-8">
        ...
        <article className="card bg-violet-700 relative ">
          <img
            src={quoteIcon}
            alt="quotation icon"
            className="w-32 h-32 absolute right-5 top-0 z-10"
          />
          ...
          <h1 className="text-h1Size font-bold relative z-20">
        ...
        <article className="card bg-slate-600">
          ...
          <h2 className="text-h2Size font-bold">
        ...
        <article className="card bg-white">
          ...
          <h2 className="text-h2Size text-slate-700 font-bold">
        ...
        {/* user 4 */}
        <article className="card bg-slate-900">
          <div className="user-infos">
            <img
              src={patrick}
              alt="user profile pic icon"
